...
/* harmony import */ var _modules_init_slider_photos__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-slider-photos */ "./js/modules/init-slider-photos.js");
/* harmony import */ var _modules_init_maps__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-maps */ "./js/modules/init-maps.js");
/* harmony import */ var _utils_dynamic_adaptive_init_dynamic_adaptive__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils/dynamic-adaptive/init-dynamic-adaptive */ "./js/utils/dynamic-adaptive/init-dynamic-adaptive.js");
/* harmony import */ var _modules_init_youtube_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/init-youtube.js */ "./js/modules/init-youtube.js");
/* harmony import */ var _utils_fix_transition__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./utils/fix-transition */ "./js/utils/fix-transition.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_utils_dynamic_adaptive_init_dynamic_adaptive__WEBPACK_IMPORTED_MODULE_7__["initDynamicAdaptive"])();
  // Исправляет блики из-за transition при ресайзе
  Object(_utils_fix_transition__WEBPACK_IMPORTED_MODULE_9__["fixTransition"])();
  ...
  Object(_modules_init_slider_photos__WEBPACK_IMPORTED_MODULE_5__["initSliderPhotos"])();
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_maps__WEBPACK_IMPORTED_MODULE_6__["initMaps"])();
    // слушает клик на массиве кнопок включения видео
    Object(_modules_init_youtube_js__WEBPACK_IMPORTED_MODULE_8__["initYoutube"])();
  });
});
...
var searchSuccessCallback = function searchSuccessCallback() {};
var searchErrorCallback = function searchErrorCallback(event) {
  event.preventDefault();
};
var callbacks = {
  base: {
...
var Burger = /*#__PURE__*/function () {
  function Burger() {
    ...
    this._scrollLock = scroll_lock__WEBPACK_IMPORTED_MODULE_0___default.a;
...
/* harmony import */ var _nav_accordion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./nav-accordion */ "./js/modules/header/nav-accordion.js");
/* harmony import */ var _search_form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./search-form */ "./js/modules/header/search-form.js");
/* harmony import */ var _modal_search__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modal-search */ "./js/modules/header/modal-search.js");
...
var initHeader = function initHeader() {
  ...
  var navAccordion = new _nav_accordion__WEBPACK_IMPORTED_MODULE_2__["NavAccordion"]();
  navAccordion.init();

  // Сбрасывает валидацию у формы поиска при клике вне её и скролле.
  var searchForm = new _search_form__WEBPACK_IMPORTED_MODULE_3__["SearchForm"]();
  searchForm.init();
  ...
  var modalSearch = new _modal_search__WEBPACK_IMPORTED_MODULE_4__["ModalSearch"]();
  modalSearch.init();
};
...
/***/ "./js/modules/header/modal-search.js":
/*!*******************************************!*\
  !*** ./js/modules/header/modal-search.js ***!
  \*******************************************/
/*! exports provided: ModalSearch */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ModalSearch", function() { return ModalSearch; });
...
// Закрывает модальное окно с поиском при ресайзе с адаптива на десктоп.
// На десктопе блокирует кнопку открытия модального окна.
var ModalSearch = /*#__PURE__*/function () {
  ...
  _createClass(ModalSearch, [{
    ...
    key: "closeModalSearch",
    value: function closeModalSearch() {
      var isDesktop = this.vp1280.matches;
      var isOpen = this.modalSearch.classList.contains('is-active');
      if (isDesktop && isOpen) {
        // !Закрывает модальное окно с помощью интерфеиса Modals.
        _modals_init_modals__WEBPACK_IMPORTED_MODULE_0__["modals"].close('search');
      }
    }

    // Блокирует кнопку открытия модального окна.
  }, {
    key: "disableModalToggle",
    value: function disableModalToggle() {
...
/***/ "./js/modules/header/nav-accordion.js":
/*!********************************************!*\
  !*** ./js/modules/header/nav-accordion.js ***!
  \********************************************/
/*! exports provided: NavAccordion */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NavAccordion", function() { return NavAccordion; });
/* harmony import */ var _accordion_init_accordion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../accordion/init-accordion */ "./js/modules/accordion/init-accordion.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
// Закрывает аккордеон при клике вне его, скролле и ресайзе.
// Исправляет навигацию по аккордеону с помощью таба.
var NavAccordion = /*#__PURE__*/function () {
  function NavAccordion() {
    _classCallCheck(this, NavAccordion);
  ...
  _createClass(NavAccordion, [{
    ...
    value: function closeAccordion() {
      var accordionParent = this.container.querySelector('[data-accordion="parent"]');
      var elements = _toConsumableArray(accordionParent.querySelectorAll('[data-accordion="element"]'));
      var isOpened = elements.some(function (item) {
        return item.classList.contains('is-active');
      });
      if (!isOpened) {
        return;
      }
      var activeAccordion = elements.find(function (item) {
        return item.classList.contains('is-active');
      });
      this.toggleTabIndex(activeAccordion);
      this.resetScroll();
      // !Закрывает аккордеон с помощью интерфеиса Accordions.
      _accordion_init_accordion__WEBPACK_IMPORTED_MODULE_0__["accordions"].closeAllAccordion(accordionParent);
    ...
    key: "toggleTabIndex",
    value: function toggleTabIndex(target) {
      var element = target.closest('[data-accordion="element"]');
      var links = element.querySelectorAll('.nav__link--sublink:not(.nav__link--current)');
      if (!element.classList.contains('is-active')) {
    ...
    value: function resetScroll() {
      var accordionWrapper = this.container.querySelector('[data-accordion="wrapper"]');
    ...
    value: function onDocumentClick(event) {
      ...
      var isAccordion = target.closest('[data-nav-accordion]');
      var isButton = target.closest('[data-accordion="button"]');
      if (!isAccordion) {
        this.closeAccordion();
      }
      if (isButton) {
...
var SearchForm = /*#__PURE__*/function () {
  ...
  _createClass(SearchForm, [{
    ...
    value: function resetValidation() {
      var customInput = this.searchForm.querySelector('[data-search-form="input"]');
      var input = customInput.querySelector('input');
      var isInvalid = customInput.classList.contains('is-invalid');
      if (isInvalid) {
    ...
    key: "onDocumentClick",
    value: function onDocumentClick(event) {
      var isForm = event.target.closest('[data-search-form]');
      var isButton = event.target.closest('[data-search-form="button"]');
      if (!isForm) {
...
var StickyHeader = /*#__PURE__*/function () {
  ...
  _createClass(StickyHeader, [{
    ...
    key: "_setMainOffset",
    value: function _setMainOffset() {
      var headerHeight = this._stickyHeader.offsetHeight;
      var mainStyle = window.getComputedStyle(this._main, null);
      var mainOffset = parseInt(mainStyle.paddingTop, 10);
      if (headerHeight !== mainOffset) {
        this._main.style.paddingTop = "".concat(headerHeight, "px");
      }
    }
  }, {
    key: "_hideHeader",
...
var initMaps = function initMaps() {
  ...
  var _iterator = _createForOfIteratorHelper(mapElements),
    _step;
  try {
    var _loop = function _loop() {
      ...
      var centerData = element.dataset.center.split(', ');
      var pin = element.dataset.pin.split(', ');
      var balloonHeader = element.dataset.balloonHeader;
      var balloonBody = element.dataset.balloonBody;
      var balloonFooter = element.dataset.balloonFooter;
      ...
      ymaps.ready(function () {
        ...
        // eslint-disable-next-line no-undef
        var placemark = new ymaps.Placemark(pin, {
...
/*!******************************************!*\
  !*** ./js/modules/init-slider-photos.js ***!
  \******************************************/
/*! exports provided: initSliderPhotos */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSliderPhotos", function() { return initSliderPhotos; });
// инициализирует слайдер с фото на странице фотоотчета
var initSliderPhotos = function initSliderPhotos() {
  setTimeout(function () {
...
var onYouTubeIframeAPIReady = function onYouTubeIframeAPIReady(idVideo) {
...
var initYoutube = function initYoutube() {
  buttons.forEach(function (button) {
    button.addEventListener('click', function (event) {
      event.preventDefault();
      var idVideo = button.getAttribute('data-btn');
  ...
  _createClass(Modals, [{
    ...
    value: function close() {
      ...
      if (this._enableScrolling) {
        setTimeout(function () {
          _this2._scrollLock.enablePageScroll();
        }, this._eventTimeout);
      }
      setTimeout(function () {
...
/***/ "./js/utils/dynamic-adaptive/dynamic-adaptive.js":
/*!*******************************************************!*\
  !*** ./js/utils/dynamic-adaptive/dynamic-adaptive.js ***!
  \*******************************************************/
...
/***/ "./js/utils/dynamic-adaptive/init-dynamic-adaptive.js":
/*!************************************************************!*\
  !*** ./js/utils/dynamic-adaptive/init-dynamic-adaptive.js ***!
  \************************************************************/
...
/***/ "./js/utils/fix-transition.js":
/*!************************************!*\
  !*** ./js/utils/fix-transition.js ***!
  \************************************/
/*! exports provided: fixTransition */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fixTransition", function() { return fixTransition; });
// Добавляет класс 'no-transition' при ресайзе.
var removeTransition = function removeTransition(element) {
...
var fixTransition = function fixTransition() {
  var elements = document.querySelectorAll('[data-fix-transition]');
  if (!elements) {
    return;
  }
