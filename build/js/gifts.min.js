...
/******/ 	return __webpack_require__(__webpack_require__.s = "./js/gifts.js");
/******/ })
/************************************************************************/
/******/ ({
...
function loadData() {
  ...
  fetch('https://api.academjazzclub.ru/api/v1/get-category', {
    ...
    var data = output;
    var content = data.category_content[1].content;
    var p = document.createElement('p');
    p.innerHTML = content;
    p.removeChild(p.querySelector('a.pn-button'));
    p.removeChild(p.querySelector('a.pn-button'));
    document.querySelector('.page-title .title').innerHTML = "".concat(data.category_info.h1);
    ...
    document.querySelector('.gift-intro-banner__text .text-content').innerHTML = "<p>".concat(p.outerHTML.replaceAll('\n', '<br>'), "</p>");
  });
  endLoad();
}
document.addEventListener('DOMContentLoaded', function () {
  setInterval(function () {
    function gift() {
      document.querySelectorAll('.gift-intro-banner__button .btn').forEach(function (e) {
...
/******/ });
//# sourceMappingURL=gifts.min.js.map