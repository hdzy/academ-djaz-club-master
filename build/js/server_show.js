  ...
  fetch('https://api.academjazzclub.ru/api/v1/get-event', {
    ...
    headers: {
      ...
      .then((output) => {
        ...
        document.querySelector('.main-information__image img').src = 'img/content/' + data.photo_url;
        document.querySelector('.main-information__image img').srcset = 'img/content/' + data.photo_url;
