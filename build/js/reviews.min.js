...
/******/ 	return __webpack_require__(__webpack_require__.s = "./js/reviews.js");
/******/ })
/************************************************************************/
/******/ ({
...
function loadData() {
  ...
  fetch('https://api.academjazzclub.ru/api/v1/get-category', {
    ...
    document.querySelector('.video-block .grid').innerHTML = "".concat(data.category_content.map(function (e) {
      return "<div class=\"video-card\">".concat(e.content, "</div>");
    }).join(''));
    endLoad();
  });
}
