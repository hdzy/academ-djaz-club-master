...
/******/ 	return __webpack_require__(__webpack_require__.s = "./js/server-contacts.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./js/server-contacts.js":
/*!*******************************!*\
  !*** ./js/server-contacts.js ***!
  \*******************************/
...
function loadData() {
  ...
  fetch('https://api.academjazzclub.ru/api/v1/get-category', {
    ...
    document.querySelector('.contacts-block__wrapper .grid .info-card:first-of-type').innerHTML = "\n                      <p class=\"title title--h3 title--no-text-transform title--pink info-card__title\">\u0410\u0434\u0440\u0435\u0441</p>\n                      <address>".concat(cards[0].title, "</address>\n        ");
    document.querySelector('.contacts-block__wrapper .grid .info-card:nth-of-type(2)').innerHTML = "\n                      <p class=\"title title--h3 title--no-text-transform title--pink info-card__title\">".concat(cards[1].title.split(': ')[0], "</p>\n                      <p><a href=\"tel:").concat(cards[1].title.split(': ')[1].replaceAll(' ', '').replaceAll('(', '').replaceAll('-', '').replaceAll(')', ''), "\">").concat(cards[1].title.split(': ')[1], "</a></p>\n        ");
    document.querySelector('.contacts-block__wrapper .grid .info-card:nth-of-type(3)').innerHTML = "\n                      <p class=\"title title--h3 title--no-text-transform title--pink info-card__title\">".concat(cards[2].title.split(': ')[0], "</p>\n                      <p><a href=\"tel:").concat(cards[2].title.split(': ')[1].replaceAll(' ', '').replaceAll('(', '').replaceAll('-', '').replaceAll(')', ''), "\"\">").concat(cards[2].title.split(': ')[1], "</a></p>\n        ");
    document.querySelectorAll('.contacts-block__wrapper .grid')[1].querySelector('.info-card:nth-of-type(1)').innerHTML = "\n                      <h2 class=\"title title--h3 info-card__heading-title\">".concat(cards[3].title.split(': ')[0], "</h2>\n                      <p class=\"title title--h3 title--no-text-transform title--pink info-card__title\">").concat(cards[3].content.split(': ')[0], "</p>\n                      <p>").concat(cards[3].content.split(': ')[1] + cards[3].content.split(': ')[2], "</p>\n        ");
    document.querySelectorAll('.contacts-block__wrapper .grid')[1].querySelector('.info-card:nth-of-type(2)').innerHTML = "\n                      <h2 class=\"title title--h3 info-card__heading-title\">".concat(cards[4].title.split(': ')[0], "</h2>\n                      <p class=\"title title--h3 title--no-text-transform title--pink info-card__title\">").concat(cards[4].content.split('\r\n')[0], "</p>\n                      <p>").concat(cards[4].content.split('\r\n')[1], "</p>\n        ");
    ...
    document.querySelector('.page-title').innerHTML += "<p>".concat(text.description, "</p>");
    document.querySelector('.contacts-map__wrapper').innerHTML = "\n                       <div class=\"page-title page-title--closer\">\n                    <h3 class=\"title title--h3\">".concat(other[0].title, "</h3>\n                  </div>\n                  ").concat(other[0].content, "\n        ");
    document.querySelector('.contacts-socials .container').innerHTML = "\n      <div class=\"page-title page-title--closer\">\n                    <h3 class=\"title title--h3\">".concat(other[1].title, "</h3>\n                  </div>\n                  ").concat(other[1].content, "\n                  <img src=\"https://academjazzclub.ru/images/pages/th/").concat(other[1].photo_url, "\" alt=\"\">\n      ");
...
/******/ });
//# sourceMappingURL=servercontact.min.js.map